  ...
  if (selection.lenght === 0) {
    ...
    if (artboardLayer.type !== "Artboard") {
      ...
      getApiKey().then(function (apiKey) {
        ...
        sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("🧠 Please wait for the magic heatmap..."); // Setting up the options for the Artboard temporary export
        ...
        formData.append("image", "data:image/png;base64," + base64 + ""); // const apiURL = "https://en53hszfpit7s.x.pipedream.net";

        var apiURL = "https://api.visualeyes.loceye.io/predict/";
        sketch_polyfill_fetch__WEBPACK_IMPORTED_MODULE_2___default()(apiURL, {
          method: "POST",
          body: formData,
          headers: {
          ...
          if (status === 200) {
            ...
            sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("\uD83D\uDE31 We are deeply sorry, but something went terrible wrong!");
          } else if (status === 403) {
            sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("\uD83D\uDEA8 Your heatmaps limit has been exceeded");
          }
          ...
          sketch__WEBPACK_IMPORTED_MODULE_0__["UI"].message("\uD83C\uDF89 Bazinga!");
